...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (listaCapitole == null) {
            getCaptioleDB();
        }
    }

    private static void showMesajInternet(Activity context) {
        LayoutInflater inflater = context.getLayoutInflater();
        View layout = inflater.inflate(R.layout.forma_toast_internet, context.findViewById(R.id.llInternet));
    ...
    private void showToastNume(String nume) {
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.forma_toast_bineaivenit, findViewById(R.id.llBineaivenit));
        TextView tvNume = layout.findViewById(R.id.tvNumeToast);
        tvNume.setText(nume);
    ...
    protected void onDestroy() {
        ...
        Intent service = new Intent(MainActivity.this, SunetFundalService.class);
        stopService(service);
    ...
    protected static void handleSunetFundal(Context context) {
        SharedPreferences preferinteMuzica = context.getSharedPreferences(context.getString(R.string.shprefs_numefisier), MODE_PRIVATE);
        Boolean b = preferinteMuzica.getBoolean("Muzica", true);
        if (!b) {
            context.stopService(new Intent(context, SunetFundalService.class));
        } else {
            context.startService(new Intent(context, SunetFundalService.class));
        }
    }
